...
$(function () {
    ...
    var dataPanel = new Vue({
        ...
        beforeCreate: function () {
            ...
            gsheet.run({
                ...
                filter: {
                    ...
                    let reviewer = $.grep(self.reviewers, function (o: any, index) {
        ...
        methods: {
            setReviewer: function (event: Event) {
                let rid = $(event.target).data('reviewer-id');
                let rname = $(event.target).data('reviewer-name');
                this.rid = rid;
                this.rname = rname;
            ...
            setTeam: function (even: Event) {
                this.tid = $(event.target).data('team-id');
            },
            sendScore: function (even: Event) {
                loader.start();
